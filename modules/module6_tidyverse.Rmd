...
3) gapminder %>% select(gapminder, continent)
4) gapminder %>% select(gapminder, 'continent')
5) gapminder$continent
...
gapminder <- gapminder %>% select(-mean.continent.GDP) # drop a column with - 
# OR
...
**POLL 6B**: Which of these has the same number of rows as the original gapminder dataframe?
...
* `ggplot2` for plotting (We'll cover this in module 8)
