...
Question 1: Which of these give exactly this result: `pi`, `2*pi`, `3*pi`, ...?
...
Question 2: Which of these do you think will be fastest for a long vector, x?
...
In module 4, we sorted the gapminder `data.frame`.
