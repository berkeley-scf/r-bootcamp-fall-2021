...
**POLL 7B** Suppose you see this syntax when using the output of a regression:
...
**POLL 7C**:  Suppose you want know the probability of getting 4 or fewer heads when flipping a coin 10 times. Which of the following will work?
