...
ggplot(data = gapminderChina, aes(x = year, y = lifeExp)) +
            geom_line(color = "red")
```
...
1) gap %>% ggplot(aes(x = gdpPercap, y = lifeExp)) %>% geom_point()
2) gap %>% ggplot(aes(x = gdpPercap, y = lifeExp))
3) gap %>% ggplot(aes(x = gdpPercap, y = lifeExp)) + geom_point()
4) gap %>% ggplot(aes(x = gdpPercap, y = lifeExp, shape = 'a')) + geom_point()
5) gap %>% ggplot(aes(x = gdpPercap, y = lifeExp)) + geom_point(aes(shape = country), show.legend = FALSE)
6) gap %>% ggplot(aes(x = gdpPercap, y = lifeExp)) + geom_point(shape = 'a', show.legend = FALSE)
7) gap %>% ggplot() + geom_point(aes(x = gdpPercap, y = lifeExp, shape = country), show.legend = FALSE)
