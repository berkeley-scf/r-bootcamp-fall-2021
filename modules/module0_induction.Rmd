...
Counselors will be available to help answer any questions you have (just wave to one of them), or feel free to just ask the presenter during the presentation. The counselors will also be monitoring the [Google group Q&A area](https://groups.google.com/a/lists.berkeley.edu/d/forum/r-bootcamp-fall-2021), so feel free to type in a question there (or send email to r-bootcamp-fall-2021@lists.berkeley.edu) and one of the counselors will answer the question. Or if you know the answer, help us out by answering it yourself or adding your thoughts. 

Your counseloRs are: Your counseloRs are: Andrew Do (Statistics), Corrine Elliott (Statistics), Hikari Murayama (D-Lab), Avery Richards (D-Lab), Alex Stephenson (D-Lab), and ...
...
Note: The files named *moduleX_blah.html* have individual slides, while the files named *moduleX_onepage.html* have the same content but all on one page.
