...
-    Select “Download R 4.1.0 for Windows”
-    Open the downloaded file (R-4.1.0-win.exe)
...
-    Download RStudio by selecting the blue "DOWNLOAD RSTUDIO FOR WINDOWS" button. 
-    Open the downloaded file (RStudio-1.4.1717.exe)
-    Select “Run” if prompted
-    Follow the set-up instructions (if unsure of something, leave the default settings)
